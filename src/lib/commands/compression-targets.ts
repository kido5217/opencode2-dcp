import type { CompressionBlock, PruneMessagesState } from "../types.ts";

/**
 * v2 port of v1 `lib/commands/compression-targets.ts` — pure state logic,
 * verbatim. Import rewrite only (`../state` -> `../types.ts`).
 */
