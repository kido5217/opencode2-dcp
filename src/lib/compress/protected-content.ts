...
import { buildSubagentResultText, getSubAgentId, mergeSubagentResult } from "./subagent-results.ts";
import type { SearchContext, SelectionResolution } from "./types.ts";
          ...
          if (
            ...
            if (cachedSubAgentResult !== undefined) {
              ...
              if (subAgentSessionId) {
                ...
                try {
                  const subAgentMessages = await fetchDurableMessages(subAgentSessionId);
