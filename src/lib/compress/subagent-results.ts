...
/**
 * v1 `lib/subagents/subagent-results.ts` (verbatim) — the WithParts
 * originals used by the compress pipeline's `appendProtectedTools`.
 * The #12 request-pipeline durable version lives in
 * `src/lib/subagents/subagent-results.ts`; this module is the
 * session-message-shape sibling.
 */
